...
class CifarModel(object):
  ...
  def _setup_images_and_labels(self):
    ...
    if FLAGS.dataset in ['cifar10', 'cifar10_10k', 'cifar10_30k', 'cifar102', 'cifar102_30k']:
      self.num_classes = 10
...
def main(_):
  ...
  if FLAGS.dataset not in ['cifar10', 'cifar100', 'cifar10_10k', 'cifar10_30k', 'cifar102', 'cifar102_30k']: # edit to accomodate new training sets
