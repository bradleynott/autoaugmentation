  ...
  def __init__(self, hparams):
    ...
    if hparams.dataset != 'test':
      for file_num, f in enumerate(datafiles):
        ...
        elif f in ['cifar10_10k_test_py27', 'cifar10_30k_test_py27', 'cifar102_min_overlap_test_v4_py27', 'cifar102_30k_test_py27', 'cifar105_test', 'cifar10_12k_test']:
          test_data[0] = copy.deepcopy(d[b'data'])
        ...
        elif hparams.dataset in ['cifar10', 'cifar10_10k', 'cifar10_30k', 'cifar102', 'cifar102_30k', 'cifar10_12k', 'cifar105']:
          labels = np.array(d[b'labels'])
