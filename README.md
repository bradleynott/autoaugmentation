...
An overview of necessary code adjustments and the AWS training approach is provided here. The `alternate_training` directory within this repository contains an explanation for training on a cloud instance configured from a bare bones Ubuntu installation.
